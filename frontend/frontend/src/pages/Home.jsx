  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 px-8 py-16">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-semibold tracking-tight text-gray-900 mb-2">Bookshop</h1>
        <p className="text-gray-500 mb-12 text-lg">Thoughtfully curated reads.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {books.map(book => (
              ...
              >
                ...
                <p className="text-xs font-medium uppercase tracking-widest text-gray-400 mb-2">Book</p>
                <h2 className="text-base font-semibold text-gray-900 leading-snug flex-1 mb-6">{book.title}</h2>
